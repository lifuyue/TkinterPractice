...
def main():
    ...
    ok_goodbye_button = ttk.Button(frame1, text='Check for ok')
    ok_goodbye_button.grid()

    ok_goodbye_button['command'] = lambda: check_for_ok(my_entry_box)
    ...
    more_typing_button = ttk.Button(frame1, text='More typing')
    more_typing_button.grid()

    more_typing_button['command'] = lambda: more_typing(my_entry_box, my_second_entry_box)
...
def more_typing(entry_box1, entry_box2):
